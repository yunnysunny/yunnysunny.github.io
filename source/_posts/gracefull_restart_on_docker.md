...
> 本文原始链接 https://blog.whyun.com/posts/gracefully-restart-on-docker/ ，转载请求注明出处。
## 1. 自带解决方案
...
> 本小节中的代码都能从[dockerfiles](https://github.com/yunnysunny/dockerfiles/blob/master/supervisor/Dockerfile)找到源代码
